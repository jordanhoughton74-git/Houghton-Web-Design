  ...
  function sendEmail(e){
    ...
    return (
        ...
        <form onSubmit={sendEmail}>
          ...
          <div className="mt-4">
            <label className="uppercase text-sm text-gray-600 dark:text-gray-200 font-bold">What is your budget?
            <select className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              required
              onChange={handleChange}
              id="subject"
              type="text" 
              name="subject">
                <option value={form.subject}>£250-£500</option>
                <option value={form.subject}>£500-£750</option>
                <option value={form.subject}>£750-£1000</option>
                <option value={form.subject}>£1000+</option>
              </select>
              </label>

          </div>
          <div className="mt-4">
            <label className="uppercase text-sm text-gray-600 dark:text-gray-200 font-bold">Tell me about your project and the pages you need for your website.<br/>
            <span className='text-sm font-normal'>For example (Home, About, Portfolio)</span>
            <textarea
