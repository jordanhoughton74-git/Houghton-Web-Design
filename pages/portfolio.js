...
export default function Portfolio(){
    return(
        ...
        <div className='pt-10 pb-20 bg-gradient-to-r from-green-100 to-blue-100 relative'>
        ...
        <div className='bg-gradient-to-r from-green-100 to-blue-100 py-20 relative px-2'>
            <WaveBottom />
            <WaveTop />
        ...
        <div className='bg-gradient-to-r from-green-100 to-blue-100 py-20 relative px-2'>
            ...
            <div className='max-w-7xl mx-auto'>
                ...
                <p className='text-gray-700 max-w-5xl mx-auto mb-4'>A fast single page application designed to advertise a wedding venue and the various servcies/prdoucts which are offered. It features downloadable menus to entice bookings. Styleish fonts and incredible vibrant photos to catch the viewers eye.</p>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-3'>
                    <div className='my-auto'>
        ...
        <div className='max-w-7xl py-5 md:py-16 mx-auto px-2'>
            ...
            <p className='text-gray-700 max-w-5xl mx-auto mb-4'>A website designed to increase sales and advertise the beautiful Spa and Wellbeing offerings. The website has a multitude of functions, including gallery carousels and informational cards.</p>
