    ...
    <div className='max-w-7xl mx-auto py-5 md:py-20 grid grid-cols-1 md:grid-cols-2 px-3'>
      <div className='text-left'>
        <h3 className='text-3xl pb-2'>Freelance Web Designer & Developer</h3>
          <p className="text-gray-600 dark:text-gray-300">Welcome to Houghton Web Design.  My name is Jordan Houghton and I am a Freelance Web Developer & Designer based in Sittingbourne, Kent with a passion for user experience. 
        ...
        <h4 className='text-2xl py-2'>How Can I Help You?</h4>
          <p className="text-gray-700 dark:text-gray-300"><strong>Design, Development & Maintenance.</strong>  As a Freelance Web Designer I can create your website from scratch and will take care of all maintenance
        ...
        <h4 className='text-2xl py-2'>Pricing Sructure as a Web Design Freelancer</h4>
          <p className="text-gray-700 dark:text-gray-300">Contact me for a <strong>free quote</strong>. As the sole employee and owner of the business, I have incredibly low overheads.  This allows me to offer you the best price possible for your site.</p>
        <h4 className='text-2xl py-2'>Your Choice of Code.</h4>
          <p className="text-gray-700 dark:text-gray-300">I work with React.JS, Next.JS and WordPress to create the best websites
